...
rows.append(['TOTAL DE BIOLOGICO APLICADO SRP + SR', '', int(total_global)])
final_df = pd.DataFrame(rows, columns=['Tipo de Vacuna', 'Grupo de Edad', 'Total Dosis'])

# Save to Excel
output_excel = r'c:\Descargas_SRP\Resumen_Dosis_SRP_SR.xlsx'
final_df.to_excel(output_excel, index=False)

print(f"Excel summary saved to: {output_excel}")
print(f"Global Total: {total_global}")
